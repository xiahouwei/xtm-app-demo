...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  private class FlutterWebChromeClient2 extends WebChromeClient {
  ...
  FlutterWebView(
    ...
    flutterWebChromeClient = new FlutterWebChromeClient(flutterWebViewClient, this,webViewFlutterPlugin,methodChannel);
  ...
  public void dispose() {
    ...
    if(flutterWebChromeClient != null){
      flutterWebChromeClient.dispose();
    }
    if (webView instanceof InputAwareWebView) {
